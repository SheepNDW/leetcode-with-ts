...
describe.skip('relativeSortArray', () => {
  it('should return [2,2,2,1,4,3,3,9,6,7,19] for arr1 = [2,3,1,3,2,4,6,7,9,2,19], arr2 = [2,1,4,3,9,6]', () => {
  ...
  it('should return [22,28,8,6,17,44] for arr1 = [28,6,22,8,44,17], arr2 = [22,28,8,6]', () => {
